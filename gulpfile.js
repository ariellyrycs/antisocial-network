...
gulp.task('build', ['remove', 'concat', 'ugly', 'stylus', 'concatCSS', 'cssMin', 'jade', 'lint']);
gulp.task('dev', ['server', 'gulpLintFiles', 'remove', 'concat', 'ugly', 'stylus', 'concatCSS', 'cssMin', 'jade', 'lint', 'watch', 'connectDev']);
